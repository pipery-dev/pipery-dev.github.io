---
title: "Pipery npm CD"
description: "CD pipeline for npm/Node.js: download package/image, deploy (ArgoCD/Cloud Run/Helm/Ansible), check status"
type: "docs"
weight: 9
---
...
- Repository: [`pipery-npm-cd`](https://github.com/pipery-dev/pipery-npm-cd)
- Release tag: `v1`
- Catalog: [/catalog/](/catalog/)

Reusable GitHub Action for npm/Node.js CD — download package or image, deploy, and verify — with structured logging via [Pipery](https://pipery.dev).

[![GitHub Marketplace](https://img.shields.io/badge/Marketplace-Pipery%20npm%20CD-blue?logo=github)](https://github.com/marketplace/actions/pipery-npm-cd)
...
|---|---|---|
| Download | `npm pack` or `docker pull` the package/image | `skip_download` |
...
| `package_version` | `latest` | npm package version. |
