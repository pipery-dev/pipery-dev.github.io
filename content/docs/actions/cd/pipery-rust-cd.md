...
description: "CD pipeline for Rust: download binary/image, deploy (ArgoCD/Cloud Run/Helm/Ansible), check status"
type: "docs"
weight: 11
---
...
- Repository: [`pipery-rust-cd`](https://github.com/pipery-dev/pipery-rust-cd)
- Release tag: `v1`
- Catalog: [/catalog/](/catalog/)

Reusable GitHub Action for Rust CD — download binary or image, deploy, and verify — with structured logging via [Pipery](https://pipery.dev).

[![GitHub Marketplace](https://img.shields.io/badge/Marketplace-Pipery%20Rust%20CD-blue?logo=github)](https://github.com/marketplace/actions/pipery-rust-cd)
...
|---|---|---|
| Download | Download GitHub release binary or pull Docker image | `skip_download` |
