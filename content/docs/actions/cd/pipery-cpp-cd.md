---
title: "Pipery C/C++ CD"
description: "CD pipeline for C/C++: download binary/image, deploy (ArgoCD/Cloud Run/Helm/Ansible), check status"
type: "docs"
weight: 3
---
...
- Repository: [`pipery-cpp-cd`](https://github.com/pipery-dev/pipery-cpp-cd)
- Release tag: `v1`
- Catalog: [/catalog/](/catalog/)

Reusable GitHub Action for C/C++ CD — download binary or image, deploy, and verify — with structured logging via [Pipery](https://pipery.dev).

[![GitHub Marketplace](https://img.shields.io/badge/Marketplace-Pipery%20C/C++%20CD-blue?logo=github)](https://github.com/marketplace/actions/pipery-c-c-cd)
  ...
  cd:
    ...
    steps:
      ...
      - uses: pipery-dev/pipery-cpp-cd@v1
        with:
          artifact_name: my-app-linux-amd64.tar.gz
          artifact_version: latest
          deploy_target: ansible
          ansible_playbook: deploy/playbook.yml
          ansible_inventory: deploy/hosts.ini
```
...
|---|---|---|
| Download | Download GitHub release tarball or pull Docker image | `skip_download` |
...
|---|---|---|
| `artifact_name` | `` | GitHub release artifact name (e.g. `app.tar.gz`). |
