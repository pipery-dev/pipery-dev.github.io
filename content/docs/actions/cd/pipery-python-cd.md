...
description: "CD pipeline for Python: download package, deploy (ArgoCD/Cloud Run/Helm/Ansible), check status"
type: "docs"
weight: 10
---
...
- Repository: [`pipery-python-cd`](https://github.com/pipery-dev/pipery-python-cd)
- Release tag: `v1`
- Catalog: [/catalog/](/catalog/)

Reusable GitHub Action for Python CD — download package or image, deploy, and verify — with structured logging via [Pipery](https://pipery.dev).

[![GitHub Marketplace](https://img.shields.io/badge/Marketplace-Pipery%20Python%20CD-blue?logo=github)](https://github.com/marketplace/actions/pipery-python-cd)
...
|---|---|---|
| Download | `pip download` or `docker pull` the package/image | `skip_download` |
...
|---|---|---|
| `package_name` | `` | PyPI package name to download. |
| `package_version` | `latest` | Package version to download. |
| `image_name` | `` | Docker image to pull (alternative to PyPI). |
