...
description: "CI pipeline for Docker: lint (hadolint), SAST, SCA, build, test, versioning, push image, reintegration"
type: "docs"
weight: 2
---
...
definitions:
  imports:
    pipery-shared: pipery-docker-ci:v1
    pipery-custom: pipery-docker-ci:v1:.bitbucket/shared-pipelines.yml
