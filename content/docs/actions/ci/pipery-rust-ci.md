...
description: "CI pipeline for Rust: SAST, SCA, lint, build, test, versioning, packaging, release, reintegration"
type: "docs"
weight: 7
---
...
- Repository: [`pipery-rust-ci`](https://github.com/pipery-dev/rust-ci)
- Release tag: `v1.1.0`
...
jobs:
  ci:
    ...
    steps:
      ...
      - uses: pipery-dev/rust-ci@v1.1.0
        with:
          project_path: .
...
definitions:
  imports:
    pipery-shared: pipery-dev/rust-ci:v1.1.0
    pipery-custom: pipery-dev/rust-ci:v1.1.0:.bitbucket/shared-pipelines.yml

pipelines:
  branches:
    main:
      import: pipery-rust-ci@pipery-shared

  custom:
    run-pipery:
      import: pipery-rust-ci@pipery-custom
```
