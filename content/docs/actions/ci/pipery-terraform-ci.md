---
title: "Pipery Terraform CI"
description: "CI pipeline for Terraform: SAST (tfsec) → SCA → lint (tflint) → validate → plan → version → release"
type: "docs"
weight: 8
---
...
definitions:
  imports:
    pipery-shared: pipery-dev/pipery-terraform-ci:v1
    pipery-custom: pipery-dev/pipery-terraform-ci:v1:.bitbucket/shared-pipelines.yml
